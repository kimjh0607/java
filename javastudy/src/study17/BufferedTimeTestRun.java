...
public class BufferedTimeTestRun {
	public static void main(String[] args) {
		...
		File fileOrigin = new File("src\\study17\\files\\다운로드.png");
		File copyFile1 = new File("src\\study17\\files\\다운로드_c1.png");
		File copyFile2 = new File("src\\study17\\files\\다운로드_c2.png");
