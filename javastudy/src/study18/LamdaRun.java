...
public class LamdaRun {
	public static void main(String[] args) {
		...
		System.out.println(cal3.calc(50, 20));
		System.out.println(cal4.calc(50, 20));
		
		//참조타입으로 변환(::)
		//메서드 참조
		//클래스 이름::메서드이름 or 참조변수명::메서드이름
		StringEx2 se3 = str->str.length();
		se3 = String::length;//매개변수 str - str이 같아야 한다
		...
		//생성자 참조
		//클래스명::new
		TempEx temp =a-> new TempClass(a); //(int a) -> new TempClass(a);
		temp = TempClass::new;//
		temp.showInfo(77777777);//
	}
