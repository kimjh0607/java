...
public class FileClassRun {
	public static void main(String[] args)throws IOException{
		...
		File file2 = new File("D:\\workspace01\\javastudy\\"+ "src\\study17\\files\\TestFile.txt");
		File file3 = new File("D:/workspace01/javastudy/"+ "src/study17/files/TestFile.txt");
